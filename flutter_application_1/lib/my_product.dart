...
class Shopping extends StatefulWidget {
  ...
  @override
  State<Shopping> createState() => _MyProductState();
}

class _MyProductState extends State<Shopping> {
  ...
  void initState() {
    super.initState();
    futureProducts = testMainMuasam.getAllProduct();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      drawer: Drawer(
        child: Column(
          children: [
            // Bọc GestureDetector bên ngoài để có thể nhấn vào Header
            GestureDetector(
              onTap: () {
                // LUỒNG 3: Chuyển sang trang Profile
                Navigator.push(context,
                    MaterialPageRoute(builder: (ctx) => const ProfileScreen()));
              },
              child: const UserAccountsDrawerHeader(
                accountName: Text("Đặng Nguyễn Nhật Khánh"),
                accountEmail: Text("23T1020267@husc.edu.vn"),
            ...
            ListTile(
              ...
              onTap: () {
                // LUỒNG 2: Logout về màn hình Login
